...
public class ViewAssessmentActivity extends AppCompatActivity {
    ...
    private void onEntityLoadSucceeded(AssessmentDetails entity) {
        ...
        onTitleChanged(entity.getCode() + " - " + entity.getName());
    ...
    private void onTitleChanged(String s) {
        String v = getResources().getString(R.string.format_assessment, s);
        int i = v.indexOf(':');
    ...
    private void onSaveOperationSucceeded(List<Integer> messageIds) {
