...
public class ViewAssessmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewAssessmentPagerAdapter viewAssessmentPagerAdapter = new ViewAssessmentPagerAdapter(this, getSupportFragmentManager());
        ViewPager viewPager = findViewById(R.id.view_pager);
        viewPager.setAdapter(viewAssessmentPagerAdapter);
